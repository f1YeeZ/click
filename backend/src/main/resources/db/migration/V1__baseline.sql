...
CREATE INDEX IF NOT EXISTS idx_verification_email_purpose ON email_verification_codes(email, purpose, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_review_grip_style ON review_grip_scores(grip_style, review_id);
CREATE INDEX IF NOT EXISTS idx_review_support_review ON review_support_positions(review_id);
CREATE INDEX IF NOT EXISTS idx_review_support_position ON review_support_positions(position_code, review_id);
CREATE INDEX IF NOT EXISTS idx_users_preferred_grip ON users(preferred_grip_style, id);
