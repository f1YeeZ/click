...
<template>
  <button class="feedback-fab" type="button" aria-haspopup="dialog" aria-controls="site-feedback-dialog" @click="openDialog">
...
<style scoped>
.feedback-fab{position:fixed;right:22px;bottom:22px;z-index:70;display:inline-flex;align-items:center;gap:8px;padding:11px 15px;border:1px solid #5b5b5b;border-radius:999px;background:#191919e8;box-shadow:0 10px 35px #0008;color:#e5e5e5;font:600 .78rem var(--mono);cursor:pointer;backdrop-filter:blur(14px);transition:transform .18s ease,border-color .18s ease,background .18s ease,bottom .2s ease}.feedback-fab.has-compare-tray{bottom:96px}.feedback-fab:hover{transform:translateY(-3px);border-color:#bdbdbd;background:#252525}.feedback-fab:focus-visible{outline:2px solid var(--acid);outline-offset:3px}.feedback-fab-mark{display:grid;width:20px;height:20px;place-items:center;border:1px solid #868686;border-radius:50%;color:#f0f0f0;font-size:.72rem}.site-feedback-dialog{width:min(680px,calc(100vw - 32px));max-width:none;max-height:min(900px,calc(100dvh - 32px));padding:0;border:1px solid #3d3d3d;border-radius:20px;background:#121212;color:var(--ink);box-shadow:0 30px 90px #000b}.site-feedback-dialog::backdrop{background:#050505b8;backdrop-filter:blur(9px)}.site-feedback-dialog[open]{animation:feedback-in .22s cubic-bezier(.22,1,.36,1)}.site-feedback-shell{display:grid;grid-template-rows:auto minmax(0,1fr) auto;max-height:min(900px,calc(100dvh - 32px));margin:0}.site-feedback-header{display:flex;align-items:flex-start;justify-content:space-between;gap:18px;padding:22px 24px 18px;border-bottom:1px solid #313131;background:linear-gradient(135deg,#202020,#151515)}.site-feedback-header>div{display:grid;gap:7px}.site-feedback-header small{color:#929292;font:600 .68rem var(--mono);letter-spacing:.14em}.site-feedback-header h2{margin:0;color:#f0f0f0;font-size:1.5rem;letter-spacing:-.04em}.site-feedback-header p{margin:0;color:#9d9d9d;font-size:.78rem;line-height:1.55}.site-feedback-close{display:grid;place-items:center;flex:0 0 38px;width:38px;height:38px;border:1px solid #414141;border-radius:10px;background:#ffffff08;color:#aaa;font-size:1.3rem;cursor:pointer}.site-feedback-close:hover{background:#fff1;color:#fff}.site-feedback-body{display:grid;gap:14px;overflow:auto;padding:18px 24px 20px}.site-feedback-notice{padding:11px 13px;border:1px solid #444;border-radius:10px;font-size:.77rem}.site-feedback-notice.success{border-color:#6a6a6a;background:#d9d9d90b;color:#ddd}.site-feedback-notice.error{border-color:#777;background:#fff1;color:#f1f1f1}.site-feedback-types{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin:0;padding:0;border:0}.site-feedback-types legend{grid-column:1/-1;margin-bottom:1px;color:#b3b3b3;font:600 .73rem var(--mono);letter-spacing:.09em}.site-feedback-types label{display:flex;align-items:flex-start;gap:9px;min-height:60px;padding:10px;border:1px solid #343434;border-radius:11px;background:#191919;color:#aaa;cursor:pointer;transition:border-color .15s ease,background .15s ease,color .15s ease}.site-feedback-types label.active{border-color:#8e8e8e;background:#e4e4e40a;color:#eee}.site-feedback-types input{position:absolute;opacity:0;pointer-events:none}.site-feedback-types label:focus-within{outline:2px solid #777;outline-offset:2px}.site-feedback-types span{display:grid;gap:3px}.site-feedback-types strong{font-size:.78rem;font-weight:600}.site-feedback-types small{color:#828282;font-size:.66rem;line-height:1.35}.site-feedback-field{display:grid;gap:7px;color:#b4b4b4;font-size:.74rem;font-weight:600}.site-feedback-field>span{display:flex;align-items:center;gap:7px}.site-feedback-field b{color:#a8a8a8;font:600 .63rem var(--mono)}.site-feedback-field em{color:#7d7d7d;font-style:normal;font-weight:400}.site-feedback-field input,.site-feedback-field textarea{width:100%;border:1px solid #3c3c3c;border-radius:10px;padding:11px 12px;background:#0b0b0b;color:#e5e5e5;outline:0;font:inherit}.site-feedback-field textarea{min-height:112px;resize:vertical;line-height:1.55}.site-feedback-field input:focus,.site-feedback-field textarea:focus{border-color:#9b9b9b;box-shadow:0 0 0 3px #9b9b9b1c}.site-feedback-field input::placeholder,.site-feedback-field textarea::placeholder{color:#676767}.site-feedback-field>small{justify-self:end;color:#707070;font: .65rem var(--mono);font-weight:400}.site-feedback-footer{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:14px 24px 17px;border-top:1px solid #303030;background:#151515}.site-feedback-footer>span{max-width:265px;color:#737373;font-size:.66rem;line-height:1.45}.site-feedback-footer>div{display:flex;gap:8px}.site-feedback-footer .button{min-width:95px}.feedback-submit{background:#dedede;color:#121212}.feedback-submit:hover{background:#fff}.feedback-submit:disabled{opacity:.45}
.feedback-fab{position:relative;right:auto;bottom:auto;z-index:1}
.site-feedback-body{scrollbar-width:thin;scrollbar-color:#555 #181818}
.site-feedback-body::-webkit-scrollbar{width:6px}
.site-feedback-body::-webkit-scrollbar-track{border-radius:999px;background:#181818}
.site-feedback-body::-webkit-scrollbar-thumb{min-height:48px;border:1px solid #181818;border-radius:999px;background:#555;background-clip:padding-box}
.site-feedback-body::-webkit-scrollbar-thumb:hover{background:#777;background-clip:padding-box}
@keyframes feedback-in{from{opacity:0;transform:translateY(12px) scale(.985)}to{opacity:1;transform:translateY(0) scale(1)}}
@media(max-width:820px){.feedback-fab{display:none}}
@media(max-width:760px){.site-feedback-types{grid-template-columns:repeat(2,minmax(0,1fr))}}
